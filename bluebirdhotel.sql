...
-- Password:   `password`
--
-- Updated to match the hardened codebase:
--   * Password columns widened to varchar(255) so bcrypt hashes (60 chars)
--     produced by password_hash() fit.
--   * Seeded accounts ship with real bcrypt hashes.
--   * Recommend using a NEW unique salt for production (npm/openssl rand).
--
...
--   Email: Admin@gmail.com  Password: 1234  (bcrypt, verified)
--

INSERT INTO `emp_login` (`empid`, `Emp_Email`, `Emp_Password`) VALUES
(1, 'Admin@gmail.com', '$2y$10$pIKCqPQ.tz2094P/gEJHme37eNXvmysNzNnIWJ6wEFuu1pZNj0.Lm');
...
--   Email: tusharpankhaniya2202@gmail.com  Password: 123  (bcrypt, verified)
--

INSERT INTO `signup` (`UserID`, `Username`, `Email`, `Password`) VALUES
(1, 'Tushar Pankhaniya', 'tusharpankhaniya2202@gmail.com', '$2y$10$DArfJtXOWHn1mI6wFY81G.Ij4J32GIhNqH3T7tJM49hfrH3E6VjCm');
